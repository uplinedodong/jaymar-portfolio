...
const AREAS = [
    {
        ...
        desc: "Design and implement end-to-end systems, from database architecture to responsive web and mobile interfaces. Expert in production-ready apps, CRUD workflows, and real-time systems.",
        tags: ["Laravel", "Next.js", "React Native", "PHP", "MySQL", "Node.js"],
        color: "#6366f1",
        rgb: "99,102,241",
    },
    {
        ...
        desc: "Cross-platform apps built with React Native & Expo, optimized for offline-first workflows. Expertise in CRUD-heavy systems with SQLite storage and native UX polish.",
        tags: ["React Native", "Expo", "SQLite", "NativeWind", "Offline-First"],
        color: "#ec4899",
        rgb: "236,72,153",
    },
    {
        ...
        desc: "Designing scalable schemas and optimizing queries for high-performance apps. Expert in multi-database integration and real-time data synchronization.",
        tags: ["MySQL", "Firebird", "SQLite", "Firebase", "MongoDB", "ODBC"],
        color: "#38bdf8",
        rgb: "56,189,248",
    },
    {
        icon: Layers,
        title: "Billing & Government Systems",
        desc: "Developing municipal billing and LGU platforms, handling payment tracking, reconciliation, and automated report generation for production-grade government operations.",
        tags: ["VB.NET", "C#", "PowerScript", "Billing Workflows", "Reconciliation", "Reporting"],
        color: "#f59e0b",
        rgb: "245,158,11",
    },
    {
        ...
        desc: "Developing high-performance, component-based interfaces emphasizing clarity and interaction polish. Skilled in translating complex requirements into intuitive user experiences.",
        tags: ["Tailwind CSS", "Micro-animations", "Adaptive UI", "Accessibility", "Performance", "CRUD Workflows"],
        color: "#22c55e",
        rgb: "34,197,94",
    },
    {
        ...
        desc: "Deploy and maintain web/mobile apps with production-ready workflows. Expert in full-stack releases, Expo EAS, and Over-the-Air (OTA) updates for smooth iterations.",
        tags: ["Vercel", "Expo EAS", "OTA Updates", "CI/CD", "Release Mgmt"],
        color: "#a78bfa",
        rgb: "167,139,250",
    },
];
