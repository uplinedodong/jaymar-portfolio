...
export default function About() {
    ...
    return (
        <section id="about" style={{ padding: "6rem 0", background: "#030712", position: "relative" }}>
            {/* Subtle divider */}
            ...
            <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 1.5rem" }}>
                ...
                >
                    ...
                    >
                        <div style={{ position: "absolute", top: "-40px", right: "-40px", width: "180px", height: "180px", background: "radial-gradient(circle, rgba(99,102,241,0.12) 0%, transparent 70%)", pointerEvents: "none" }} />
                        ...
                        <h3 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: "1.25rem", color: "#f1f5f9", marginBottom: "1rem" }}>
                            Jaymar Aranas
                        </h3>

                        <p style={{ color: "#64748b", fontSize: "0.9375rem", lineHeight: 1.8, marginBottom: "1rem" }}>
                            A practical, production-focused Software Developer from the Philippines with a
                            strong foundation in full-stack web development and cross-platform mobile app
                            development.
                        </p>

                        <p style={{ color: "#64748b", fontSize: "0.9375rem", lineHeight: 1.8, marginBottom: "1.5rem" }}>
                            My work spans{" "}
                            <span style={{ color: "#94a3b8", fontWeight: 500 }}>government billing systems</span>,
                            {" "}<span style={{ color: "#94a3b8", fontWeight: 500 }}>business management platforms</span>,
                            {" "}and{" "}
                            <span style={{ color: "#94a3b8", fontWeight: 500 }}>consumer mobile applications</span>
                            {" "}— all built to run in production, not just demos.
                        </p>
                        ...
                        <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
                            ...
                            <a href="mailto:jaymar.aranas@email.com" className="btn-secondary" style={{ fontSize: "0.825rem", padding: "0.6rem 1.25rem" }}>
                                Email Me
                            </a>
                        </div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: "1.1rem", color: "#f1f5f9" }}>Philippines 🇵🇭</div>
                    ...
                    >
                        ...
                        <div className="gradient-text" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 800, fontSize: "2rem", lineHeight: 1 }}>3+</div>
                    ...
                    >
                        ...
                        <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 800, fontSize: "2rem", lineHeight: 1, color: "#fbbf24" }}>15+</div>
                    ...
                    >
                        ...
                        <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem" }}>
                            {["React Native", "Next.js", "TypeScript", "MySQL", "Expo", "PHP", "Tailwind CSS"].map((t) => (
