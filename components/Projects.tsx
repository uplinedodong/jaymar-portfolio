...
const PROJECTS: Project[] = [
    {
        ...
        description:
            "A comprehensive digital billing platform for local government water utilities. Includes a robust web portal for billing management and a dedicated mobile application for water meter readers to sync real-time data from the field.",
        type: "Government System",
        icon: Building2,
        techStack: ["SQL", "PHP", "SQLite", "React Native", "JavaScript", "Bootstrap", "C#", "VB.NET", "Firebird", "ODBC", "Expo", "Nodejs"],
        gradientFrom: "#0ea5e9",
        gradientTo: "#06b6d4",
        featured: true,
        metrics: [
    ...
    },
    {
        ...
        type: "Mobile App",
        icon: Smartphone,
        techStack: ["React Native", "Expo", "Laravel", "NativeWind", "Typescript"],
        gradientFrom: "#ec4899",
        gradientTo: "#f43f5e",
        featured: true,
        metrics: [
    ...
    },
    {
        ...
        type: "Government System",
        icon: Building2,
        techStack: ["PHP", "SQL", "jQuery", "Bootstrap"],
        gradientFrom: "#f59e0b",
        gradientTo: "#d97706",
    },
    {
        ...
        icon: Database,
        techStack: ["React", "PHP", "MySQL", "Javascript"],
        gradientFrom: "#22c55e",
        gradientTo: "#16a34a",
    },
    {
    ...
    },
    {
        id: "marketplace-app",
        title: "Marketplace",
        subtitle: "Community E-Commerce App",
        description:
            "A high-performance peer-to-peer marketplace built with React Native and Expo. Implements real-time product listings, secure authentication, image uploads, and instant messaging powered by Firebase.",
        type: "Mobile App",
        icon: Smartphone,
